    ...
    Ownable
{
    ...
    string private constant NAME = "TestCollectionPhase2";
    string private constant SYMBOL = "TCP2";
    uint256 private constant MAX_SUPPLY = 61;
    ...
    IFirstStage public immutable stageOneContract;
    ...
    constructor(
        ...
        stageOneContract = IFirstStage(stageOneContractAddress);
    }
